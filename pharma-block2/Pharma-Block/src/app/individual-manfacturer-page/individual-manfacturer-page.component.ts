...
@Component({
  selector: 'app-individual-manfacturer-page',
  templateUrl: './individual-manfacturer-page.component.html',
  styleUrls: ['./individual-manfacturer-page.component.css'],
  providers: [ProductService]
})
export class IndividualManfacturerPageComponent implements OnInit {
  ...
  addAsset(form: any): Promise<any> {
    this.uniqueIdentifier = this.certificateOfOrigin.value + this.batchNumber.value + this.lotSize.value;
    this.asset = {
    ...
    this.myForm.setValue({
      ...
      'retailerTemperature': 'Please enter the shipment date',
      'owner': this.owner.value,
      'issuer': this.issuer.value
    });
